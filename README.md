...
| CustomParseRulesPatch | Adds user-defined regex rules for indexer release-title parsing (title/season/episode/subgroup, forced languages/quality; season numbers support Arabic, full-width, Roman and Chinese digits) | [CustomParseRules/README.md](SonarrPatcher.Patches/CustomParseRules/README.md) |
